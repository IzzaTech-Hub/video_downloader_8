...
import '../../../data/downloaded_video.dart';
import '../../../data/downloading_video.dart';
...
//!Implementation of Video Size
  ...
  void CompleteHTML(InAppWebViewController thisController) async {
    var html = await thisController.evaluateJavascript(
        source:
            "window.document.getElementsByTagName('a').getAttribute('href')");
    // var html = await thisController.evaluateJavascript(
    //     source: "document.documentElement.outerHTML");

    if (html != null) {
      print("Complete HTML: $html");
      dp.log("Complete HTML: $html");
